	...
	const plugin = (Plugin, Api) => {
		...
		return class Slideshow extends Plugin {
			...
			getSettingsPanelExtra() {
				...
				const table = `<div class='defaultColor-2cKwKo'><p>Drag radio button to reorder images</p><table id='pseudoslideshow-backgrounds' class='pseudoslideshow-table'>
			...
			genBackgroundImage(i) {
				...
				if (backgrounds[i].local) {
					...
					const mimeType = "image/png" //mime.lookup(backgrounds[i].link); //TODO Fix mime type lookup
