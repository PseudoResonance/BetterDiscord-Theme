 ...
 * @source https://github.com/PseudoResonance/BetterDiscord-Theme/blob/master/EditUploads.plugin.js
 */
...
module.exports = (() => {
	...
	return !global.ZeresPluginLibrary ? class {
		...
		const plugin = (Plugin, Api) => {
			...
			return class EditUploads extends Plugin {
				...
				constructor() {
					...
					this.icons = {
						...
						filledRectangle: 'data:image/png;base64,',
					...
					this.tools = [{
							...
							icon: this.icons.filledRectangle,
							settings: {
								thickness: {
									type: 'range',
									min: 2,
				...
				createTools(toolbar, canvas, ctx) {
					...
					canvas.addEventListener('mousedown', e => {
						...
						this.currentTool.mouseDown.bind(this.currentTool)(canvas, ctx, {
							x: boundedX,
							y: boundedY
						}, this.toolHelpers);
					});
					const mousemoveHandler = e => {
						...
						if (this.mouseCurrentlyDown) {
							...
							const boundedX = this.clamp(canvasX, 0, canvas.width);
							const boundedY = this.clamp(canvasY, 0, canvas.height);
							this.currentTool.mouseMove.bind(this.currentTool)(canvas, ctx, {
								x: boundedX,
								y: boundedY
							}, this.toolHelpers);
						}
					...
					const mouseupHandler = e => {
						...
						const boundedX = this.clamp(canvasX, 0, canvas.width);
						const boundedY = this.clamp(canvasY, 0, canvas.height);
						this.currentTool.mouseUp.bind(this.currentTool)(canvas, ctx, {
							x: boundedX,
							y: boundedY
						}, this.toolHelpers);
					};
				...
				startEdit() {
					...
					this.editFile(file, modalWrapper)
						.then((newFile) => {
							...
							if (this.getReactInstance(icon).return.stateNode != null)
				...
				getReactInstance(element) {
					return BdApi.getInternalInstance(element);
				}
			}
		};
